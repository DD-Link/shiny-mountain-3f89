...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/shiny-mountain-3f89
```

A live public deployment of this template is available at [https://shiny-mountain-3f89.templates.workers.dev](https://shiny-mountain-3f89.templates.workers.dev)
